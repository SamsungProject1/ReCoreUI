...
###
DEVICE_MODEL_NAME="Galaxy M30S"                          # Brand name from settings config
DEVICE_SIOP_POLICY_FILENAME="siop_a51_exynos9611"                # Thermal/SIOP policy filename
DEVICE_USE_STOCK_BASE="false"
RECORE_CODENAME="shineui_m30s"
...
DEVICE_DISPLAY_REFRESH_RATE_VALUES_HZ="60"      # Supported rates by display (e.g., 60,120)
DEVICE_DEFAULT_REFRESH_RATE="60"                # Initial boot refresh rate
DEVICE_HAVE_QHD_PANEL="false"                      # True if QHD display device
DEVICE_HAVE_AMOLED_DISPLAY="false"                 # True if amoled display device
...
### Build Properties
DEVICE_FIRST_API_VERSION="9"                   # ro.vendor.build.version.release
DEVICE_FIRST_SDK_VERSION="28"                   # ro.vendor.build.version.sdk
DEVICE_VNDK_VERSION="33"                      # VNDK version
DEVICE_SINGLE_SYSTEM_IMAGE="essi"                 # ro.product.system.device

### External
DEVICE_FINGERPRINT_SENSOR_TYPE="touch_display_optical"             # Biometric sensor type
DEVICE_HAVE_LEGACY_FACE_HAL="true"                # Have legacy Samsung 2.0 biometric face libraries
